...
privileged aspect Service_Roo_Jpa_ActiveRecord {
    ...
    public static final List<String> Service.fieldNames4OrderClauseFilter = java.util.Arrays.asList("servicedescription", "createdby", "userId", "createddate", "updateddate");
    ...
    public static Service Service.findService(Long serviceid) {
    ...
    public void Service.remove() {
        ...
        if (this.entityManager.contains(this)) {
            ...
            Service attached = Service.findService(this.serviceid);
